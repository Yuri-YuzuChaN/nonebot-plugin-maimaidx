...
class DrawScore(ScoreBaseImage):
    ...
    def while_rise_pic(self, data: list[RiseResult], low_score: int, isdx: bool):
        ...
        for index, _d in enumerate(data):
            ...
            self._tb.draw(x + 315, y + 124, 18, f"ds:{_d.level_value}", id_color, anchor="lm")
    ...
    def draw_rise(
        ...
        self._sy.draw(700, height - 84, 25, "「谱面推荐不使用任何算法，仅供参考」", self._default_text_color, "mm")
        self._sy.draw(
            700, height - 36, 18, self._design_text, self._default_text_color, "mm", 2, (255, 255, 255, 255)
        )
